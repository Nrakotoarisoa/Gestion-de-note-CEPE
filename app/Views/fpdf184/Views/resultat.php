    ...
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="active">
            <a href="index.php?page=resultat">
              <i class="nc-icon nc-pin-3"></i>
              <p>Résultats</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Résultats</a>
          </div>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <form class="container-fluid" method="post">
                  <div class="input-group no-border">
                    <input type="text" name="delib" class="form-control" placeholder="Parmètre de délibération">
                    <div class="input-group-append">
                      <div class="input-group-text">
            ...
            <div class="card">
              <div class="card-title">
                <h3>Résultat: étudiant admis et échoué</h3>
              </div>
              <div class="card-body">
                <table class="table table-striped table-hover container-fluid">
                  <thead class=" text-primary">
