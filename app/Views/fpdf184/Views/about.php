      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">À propos</a>
          </div>
            ...
            <div class="card">
                <div class="card-header">
                    <?php 
                      ...
                      echo "<h6><u>Matricule</u>: " .  $_SESSION["matricule"] . "</h6>";
                      echo "<h6><u>Nom et Prénom(s)</u>: ". $_SESSION["nom"] . " " . $_SESSION["prenom"] . "</h6>";
                      echo "<h6><u>Établissement</u>: " . $_SESSION["etablissement"] . "</h6>";
                      echo "<h6><u>Année Scolaire</u>: 2022-2023</h6></div>";
                    ?> 
                </div>
                <div class="card-body">
                    ...
                    <div class="container-fluid">
                      <a href="index.php?page=editAbout"><button class="btn btn-primary btn-round">Modifier</button></a>
                      <a href="index.php?page=exporttopdf"><button class="btn btn-primary btn-round">Exporter en PDF</button></a>
                    </div>
                </div>
            </div>
          </div>
