                  ...
                  <div class="card-header">
                    ...
                    <div class="col-6 pr-0.5">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control container" name="matricule" value="<?php echo $_SESSION['matricule'];?>">
                      </div>
                    </div>
                    <div class="col-6 pr-0.5">
                      <div class="form-group">
                        <label>Nom</label>
                        <input type="text" class="form-control container" placeholder="Nom" name="nom" value="<?php echo $_SESSION['nom'];?>">
                      </div>
                    </div>
                    <div class="col-6 pr-0.5">
                      <div class="form-group">
                        <label>Prénom</label>
                        <input type="text" class="form-control container" placeholder="Prénom" name="prenom" value="<?php echo $_SESSION['prenom'];?>">
                      </div>
                    </div>
                    <div class="col-6 pr-0.5">
                      <div class="form-group">
                        <label>Établissement</label>
                        <input type="text" class="form-control container disabled" placeholder="Établissement" name="etablissement" value="<?php echo $_SESSION['etablissement'];?>">
                      </div>
                    </div>
                </div>
                <div class="card card-user">
